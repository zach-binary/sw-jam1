...
.defines(function() {
	...
	EntityCandyCounter = ig.Entity.extend({
		...
		ready: function() {
			...
			ig.assert(this.player, "Candy counter requires an entity named 'Player'");
		},
		...
		draw: function() {
			if (this.IsEditorMode()) {
				...
				this.font.draw(
					"x" + this.pad(this.player.candyCount, 2),
					this.pos.x + 25,
					this.pos.y
				);
			}
